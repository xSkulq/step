...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(3), __webpack_require__(1), __webpack_require__(132).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_step_StepMypageRegister__ = __webpack_require__(134);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('mypage-register', {
  template: `
  <div>
  ...
  methods: {
    formatDate: function(date){
      // 日付をYYYY/MM/DD
      if(!date) return '-';
      return __WEBPACK_IMPORTED_MODULE_1_moment___default()(date).format('YYYY/MM/DD');
    },
  }
})
