...
<div class="p-step_ditail">
  ...
  <section class="p-step_ditail__item">
    <div>
      ...
      <div class="p-step_ditail__challenge">
        ...
        <div>
          ...
          <p></p>
          @elseif( count($step->step_children) === $clearCount)
          <p>全てのSTEPをクリアしました<p>
          @else
          <p>クリアしました<p>
          @endif
    ...
    <a data-size="large" data-text="STEP"　href="https://twitter.com/share?url=floating-plateau-85141.herokuapp.com/step/ditail/{{ $step->id }}" class="twitter-share-button" data-show-count="false">Tweet</a>
    </div>
